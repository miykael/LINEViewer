...
.. image:: lineviewer/static/favicon_256.ico
   :width: 256pt
   :align: right
...
Full distributions like `Anaconda <https://www.continuum.io/why-anaconda>`_ provide all those packages, except `wxpython <http://wiki.wxpython.org/How%20to%20install%20wxPython>`_.
...
--------------------
  ...
  bin/
    Contains the executables for Windows, as well as the corresponding batch
    files.
  ...
  LICENSE
    LINEViewer license terms.

  README
    This document.

  setup.py
    Script for building and installing LINEViewer.
